...
## OUTPUT OF DATA TO OTHER PROGRAMS
...
## DEFINE STAGE2 AND THE SOLVING OF IT.
function buildAndSolveStage2(standX, standY, curKmax, gamma, warmstartBool, warmStartSol, cuts, fixedZ, HC)
	...
	# Fixes "z" in case of bootstrapping
	if !isempty(fixedZ)
...
## DEFINING STAGE 3 AND THE BOOTSTRAPPING
...
## MAIN LOOP TO RUN OVER DIFFERENT TIME PERIODS
@time(
